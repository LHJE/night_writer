...
class NightReaderTest < Minitest::Test
  ...
  def test_it_can_read_reader
    night_reader = NightReader.new
    ARGV[1] = "test_input_reader/message.txt"
    ARGV[0] = "test_output_reader/braille.txt"
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/backup_message.txt"
  #   ARGV[0] = "test_output_reader/braille.txt"
  #
  #   assert_equal "Created 'braille.txt' containing 184 characters", night_reader.output_statement
  # end
  #
  #
  ...
  #   ARGV[0] = "test_output_reader/braille.txt"
  #
  #   assert_equal "Created 'test_output_reader/braille.txt' containing 11 characters", night_reader.output_statement
  # end
  #
  # def test_it_can_print_ending_statement_correctly_with_diff_message
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/long_message.txt"
  #   ARGV[0] = "test_output_reader/braille.txt"
  #
  #   assert_equal "Created 'test_output_reader/braille.txt' containing 184 characters", night_reader.output_statement
  # end
  #
  # def test_it_can_write_with_writer
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message.txt"
  #   ARGV[0] = "test_output_reader/braille_for_tests.txt"
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message_for_tests.txt"
  #   ARGV[0] = "test_output_reader/braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_english
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message_a_for_tests.txt"
  #   ARGV[0] = "test_output_reader/braille_a_for_tests.txt"
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message_abc_for_tests.txt"
  #   ARGV[0] = "test_output_reader/braille_abc_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  #   assert_equal "0.0.00\n..0...\n......", night_reader.reader.read_second_arg
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/spaces.txt"
  #   ARGV[0] = "test_output_reader/actual_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  #   assert_equal "......\n......\n......", night_reader.reader.read_second_arg
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message.txt"
  #   ARGV[0] = "test_output_reader/hello_world_braille_test.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/message_for_tests.txt"
  #   ARGV[0] = "test_output_reader/capitals_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/long_message.txt"
  #   ARGV[0] = "test_output_reader/long_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[1] = "test_input_reader/all_characters.txt"
  #   ARGV[0] = "test_output_reader/all_characters_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
