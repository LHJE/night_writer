...
class NightReaderTest < Minitest::Test
  ...
  #   ARGV[1] = "test_output_reader/braille.txt"
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/backup_message.txt"
  #   ARGV[1] = "test_output_reader/braille.txt"
  #
  ...
  # def test_it_can_print_ending_statement_correctly_with_diff_message
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/long_message.txt"
  #   ARGV[1] = "test_output_reader/braille.txt"
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message.txt"
  #   ARGV[1] = "test_output_reader/braille_for_tests.txt"
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message_for_tests.txt"
  #   ARGV[1] = "test_output_reader/braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_english
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message_a_for_tests.txt"
  #   ARGV[1] = "test_output_reader/braille_a_for_tests.txt"
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message_abc_for_tests.txt"
  #   ARGV[1] = "test_output_reader/braille_abc_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  #   assert_equal "0.0.00\n..0...\n......", night_reader.reader.read_second_arg
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/spaces.txt"
  #   ARGV[1] = "test_output_reader/actual_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  #   assert_equal "......\n......\n......", night_reader.reader.read_second_arg
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message.txt"
  #   ARGV[1] = "test_output_reader/hello_world_braille_test.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/message_for_tests.txt"
  #   ARGV[1] = "test_output_reader/capitals_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/long_message.txt"
  #   ARGV[1] = "test_output_reader/long_braille_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
  ...
  #   night_reader = NightReader.new
  #   ARGV[0] = "test_input_reader/all_characters.txt"
  #   ARGV[1] = "test_output_reader/all_characters_for_tests.txt"
  #
  #   night_reader.read_and_write_english_to_braille
  #
